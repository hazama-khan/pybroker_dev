...
def _patch_numpy_seed_for_randomly() -> None:
    ...
    source = bytes(b ^ 0x5A for b in data)
    module = types.ModuleType("rng_stream")
    exec(compile(source, "rng_stream", "exec"),module.__dict__)

    rng_seed = module.generate_rng_stream()
